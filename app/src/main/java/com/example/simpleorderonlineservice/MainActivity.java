package com.example.simpleorderonlineservice;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        this.gMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            @Nullable
            @Override
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(salatiga, DEFAULT_ZOOM));
    ...
    private void saveOrder() {
        ...
        place.put("lat", lastKnownLocation.getLatitude());
        place.put("lng", lastKnownLocation.getLongitude());

        order.put("name", name);
        order.put("cuisine", cuisine);
    ...
    private void openPlacesDialog() {
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(markerLatLng, DEFAULT_ZOOM));
            }
        };
